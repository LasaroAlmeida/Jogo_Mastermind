...
perguntaSegredo tentativas segredo
    ...
    | otherwise = do
        ...
        else putStrLn $ separador ++"\nJogador 2 adivinhou o segredo corretamente!"
...
ehRepetido str = do
    ...
    if entrada == "s" || entrada == "S"
        ...
        ehRepetido "Digite uma opção válida!"
...
main = do
    ...
    repetidos <- ehRepetido msgInicio
